    ...
    <body id="page-top">
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
                ...
                <a class = "btn btn-success" href = "imprimer.php">  Imprimer liste</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					?>
						<tr>
                            ...
                            <td><center><a class = "btn btn-warning" href = "modifier_stagiaire.php?cin2=<?php echo $fetch['cin']?>" >Modifier</a> 
                            </center>
                        </td>
						</tr>
					    <?php
