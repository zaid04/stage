    ...
    <body id="page-top">
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
                ...
                <a class = "btn btn-success" href = "senc.php">  Liste des stagiaires en cours <?php echo $att['total']?></a>
                <a class = "btn btn-success" href = "sinterface1.php"> Chercher stagiaire</a>
                <a class = "btn btn-success" href = "sliste_attente.php"> Liste des stagiaires en attente <?php echo $att2['total']?></a>
