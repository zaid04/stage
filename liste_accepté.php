    ...
    <body id="page-top">
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
                ...
                <a class = "btn btn-success" href = "imprimer3.php"> Imprimer liste des stagiaires</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
                    <?php
						$query = $conn->query("SELECT * FROM `stagiaire` where status='accepté'") or die(mysqli_error($conn));
