...
include "conn.php";
$date = date("Y-m-d");
mysqli_query($conn,"update `stagiaire` set status='en cours' WHERE date_de_debut='$date' and accepté=1") or die(mysqli_error($conn));
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
    ...
    <body id="page-top">
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
                ...
                <a class = "btn btn-success" href = "imprimer2.php"> Imprimer liste des stagiaires</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
                    <?php
						$query = $conn->query("SELECT * FROM `stagiaire` where status='en attente'") or die(mysqli_error($conn));
					...
					?>
						<tr>
                            ...
                            <td><center><a class = "btn btn-warning" href = "accepter_stagiaire.php?cin2=<?php echo $fetch['cin']?>" >Accepter</a> <a class = "btn btn-warning" href="delete.php?cin2=<?php echo $fetch['cin']?>">supprimer</a> 
                            </center>
                        </td>
						</tr>
					    <?php
